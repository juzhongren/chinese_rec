...
tf.app.flags.DEFINE_integer('max_steps', 279002, 'the max training steps ')
...
def build_graph(top_k):
	...
	# rate = tf.train.exponential_decay(0.1, global_step, decay_steps=1000, decay_rate=0.9, staircase=True)
