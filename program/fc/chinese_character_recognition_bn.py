...
def build_graph(top_k):
	...
	with slim.arg_scope([slim.conv2d, slim.fully_connected],
		...
		with slim.arg_scope([slim.fully_connected],
			...
			logits = slim.fully_connected(net, FLAGS.charset_size, activation_fn=None,scope='logits')
	...
	# 		or v.name.startswith('conv2_2/Batch') or v.name.startswith('conv3_1/Batch') or v.name.startswith('conv3_2/Batch') \
	# 		or v.name.startswith('conv3_3/Batch') or v.name.startswith('conv4_1/Batch') or v.name.startswith('conv4_2/Batch') \
	# 		or v.name.startswith('conv4_3/Batch') or v.name.startswith('conv5_1/Batch') or v.name.startswith('conv5_2/Batch') \
